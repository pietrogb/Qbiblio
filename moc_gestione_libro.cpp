...
struct qt_meta_stringdata_Gestione_Libro_t {
    QByteArrayData data[12];
    char stringdata[169];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Gestione_Libro_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Gestione_Libro_t qt_meta_stringdata_Gestione_Libro = {
    {
...
QT_MOC_LITERAL(7, 99, 14),
QT_MOC_LITERAL(8, 114, 16),
QT_MOC_LITERAL(9, 131, 12),
QT_MOC_LITERAL(10, 144, 6),
QT_MOC_LITERAL(11, 151, 16)
    },
    "Gestione_Libro\0signalInsertLibro\0\0"
    "signalRemoveLibro\0signalReplaceLibro\0"
    "slotInsertLib\0slotRemoveLib\0slotReplaceLib\0"
    "slotReplaceLib_c\0slotNewLibro\0Libro*\0"
    "slotReplaceLibro\0"
};
...
void Gestione_Libro::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Gestione_Libro::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gestione_Libro::signalInsertLibro)) {
                *result = 0;
            }
        }
        {
            typedef void (Gestione_Libro::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gestione_Libro::signalRemoveLibro)) {
                *result = 1;
            }
        }
        {
            typedef void (Gestione_Libro::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gestione_Libro::signalReplaceLibro)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject Gestione_Libro::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Gestione_Libro.data,
      qt_meta_data_Gestione_Libro,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Gestione_Libro.stringdata))
