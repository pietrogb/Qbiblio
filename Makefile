...
SOURCES       = main.cpp \
		...
		View/mywidget.cpp moc_gestione_cd.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Qbiblio1.0.0/ && $(COPY_FILE) --parents Model/biblio.h Model/cd.h Model/container.h Model/dvd.h Model/film.h Model/libraryitem.h Model/libro.h Model/smartptr.h Model/vhs.h View/gestione_cd.h View/gestione_dvd.h View/gestione_libro.h View/gestione_vhs.h View/trova_elemento.h View/mywidget.h .tmp/Qbiblio1.0.0/ && $(COPY_FILE) --parents main.cpp Model/biblio.cpp Model/cd.cpp Model/dvd.cpp Model/film.cpp Model/libraryitem.cpp Model/libro.cpp Model/smartptr.cpp Model/vhs.cpp View/gestione_cd.cpp View/gestione_dvd.cpp View/gestione_libro.cpp View/gestione_vhs.cpp View/trova_elemento.cpp View/mywidget.cpp .tmp/Qbiblio1.0.0/ && (cd `dirname .tmp/Qbiblio1.0.0` && $(TAR) Qbiblio1.0.0.tar Qbiblio1.0.0 && $(COMPRESS) Qbiblio1.0.0.tar) && $(MOVE) `dirname .tmp/Qbiblio1.0.0`/Qbiblio1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Qbiblio1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_gestione_cd.cpp moc_gestione_dvd.cpp moc_gestione_libro.cpp moc_gestione_vhs.cpp moc_trova_elemento.cpp moc_mywidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_gestione_cd.cpp moc_gestione_dvd.cpp moc_gestione_libro.cpp moc_gestione_vhs.cpp moc_trova_elemento.cpp moc_mywidget.cpp
