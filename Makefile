...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Qbiblio1.0.0/ && $(COPY_FILE) --parents Model/libraryitem.h Model/libro.h Model/cd.h Model/film.h Model/dvd.h Model/vhs.h Model/container.h Model/smartptr.h View/mainwindow.h .tmp/Qbiblio1.0.0/ && $(COPY_FILE) --parents Model/libraryitem.cpp Model/libro.cpp Model/cd.cpp Model/film.cpp Model/dvd.cpp Model/vhs.cpp Model/smartptr.cpp main.cpp View/mainwindow.cpp .tmp/Qbiblio1.0.0/ && (cd `dirname .tmp/Qbiblio1.0.0` && $(TAR) Qbiblio1.0.0.tar Qbiblio1.0.0 && $(COMPRESS) Qbiblio1.0.0.tar) && $(MOVE) `dirname .tmp/Qbiblio1.0.0`/Qbiblio1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Qbiblio1.0.0
